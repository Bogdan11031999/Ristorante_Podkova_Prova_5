...
object TableConstants {
    const val TABLE_ANTIPASTIFREDDI = "antipastifreddi"
    const val TABLE_ANTIPASTICALDI = "antipasticaldi"
    const val TABLE_CAVIALE = "caviale"
    const val TABLE_PRIMI = "primi"
...
object KeyConstant{
    ...
    const val KEY_ID_ANTIPASTICALDI = "id_antipasti_caldi"
    const val KEY_ID_PRIMI = "id_primi"
